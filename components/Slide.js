...
export default function Slide() {
  return (
    <Carousel pause={false} controls={false} className='m-0 p-0'>
      <Carousel.Item>
        <Image alt='' src='metropolitan-museum-of-art-new-york-city.jpg' fluid style={{ width: '100%', height: '60vh', objectFit: 'cover' }} />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <Image alt='' src='Screenshot 2024-05-19 220130.png' fluid style={{ width: '100%', height: '60vh', objectFit: 'cover' }} />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <Image alt='' src='sothebys-com.brightspotcdn.jpg' fluid style={{ width: '100%', height: '60vh', objectFit: 'cover' }} />
        <Carousel.Caption>
